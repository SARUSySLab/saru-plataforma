...
| PIL-RF-23 | funcional | PIL-OBJ-05 | E-RF-05, E-RF-09 | PIL-RN-13 | `pipeline/decomposicao.py`; `fisica/parametros_gt3_cup.py`, presets 991.1, 991.2 e 992.1 do 911 GT3 Cup | ADR-004 | | PIL-CT-30, `tests/test_parametros_gt3_cup.py` | em andamento; os presets entraram sem validação contra manual, ver `docs/fisica-parametros-gt3-cup.md` |
...
| 2026-09-13 | PIL-RF-23 | o módulo de parâmetros do 911 GT3 Cup sai de `saru/docs/fisica/` e entra na PoC como `src/saru_poc/fisica/`, ligando a família Piloto ao E-RF-09. Nenhum valor mudou na migração | `src/saru_poc/fisica/`, `tests/test_parametros_gt3_cup.py`, `docs/fisica-parametros-gt3-cup.md`; a auditoria de proveniência abriu sete perguntas para Vitor | Vitor, 2026-09-13, no chat |
