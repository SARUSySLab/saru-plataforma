...
| E-RF-09 | estimar o carro a partir do dado | OBJ-02, OBJ-04 | E-RN-02 | `saru-poc-trackday`, `src/saru_poc/fisica/parametros_gt3_cup.py`; modelos canônicos 991.1, 991.2, 992.1 Cup, com proveniência auditada e valores pendentes de manual | E-UC-02 | a abrir | E-CT-10 | parcial | 1 |
...
| 2026-09-13 | E-RF-09 | o código dos modelos canônicos sai de `docs/fisica/` e passa a viver na PoC, em `src/saru_poc/fisica/`. Este repositório volta a ter só documento | 02, 05; PR #12 aqui e PR #17 na PoC; auditoria de proveniência abre sete perguntas para Vitor | Vitor, 2026-09-13, no chat |
