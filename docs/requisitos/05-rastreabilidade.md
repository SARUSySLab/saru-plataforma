...
| PIL-RF-29 | funcional | PIL-OBJ-06 | E-RF-09, E-RF-08 | | `fisica/parametros_gt3_cup.py`, presets 991.1, 991.2 e 992.1 do 911 GT3 Cup | | | PIL-CT-47, `tests/test_parametros_gt3_cup.py` | parcial: os presets entraram sem validação contra manual e sem proveniência por valor, ver `docs/fisica-parametros-gt3-cup.md` |
