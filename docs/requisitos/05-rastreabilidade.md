...
| 2026-09-15 | PIL-RF-12, PIL-RNF-08 | `SerieAmostras` ganha todo canal do N3 e o campo `qualidade`; o traço no tempo acrescenta faixa de qualquer canal | `src/saru_poc/relatorio.py`, `web/src/types/contract.ts`, `web/src/blocos/TracoNoTempo.tsx`, `web/src/App.tsx`, `web/scripts/gerar-fixture.mjs`, `tests/test_relatorio.py`; issue #59 | Vitor, 2026-09-15, no chat |
