...
|---|---|---|---|---|---|---|
| E-RF-01 | Ler dado de qualquer logger suportado | O núcleo deve ler o arquivo de qualquer logger da lista de formatos suportados e recusar, com motivo, o que não reconhece | F6; PRB-03 | must | E-CT-01 | parcial: 12 leitores, 6 leem amostra completa |
...
| E-CT-03 | E-RF-03, E-RNF-01 | uma gravação sem venue e sem GPS coerente | é processada | pista declarada como não resolvida, sem setor inventado. Pesquisa pendente: outras formas de resolver (perfil de velocidade, comprimento de volta, histórico do piloto) | teste; pesquisa a registrar |
