...
| 2026-09-14 | Limiar de início de frenagem por desaceleração longitudinal: -3,5 m/s² sustentado por 10 m (PIL-RN-13), confirmado após medição no acervo | 417 voltas de quatro fontes com pedal: sensibilidade de 0,948 a 0,994 e até 0,42 falso positivo por volta; platô útil de -2,5 a -4,0, e -3,5 é o centro (`docs/fisica/calibracao/2026-09-13-limiar-frenagem-por-g.md`) | -2,5 (mais falso positivo no simulador) ou -5,0 (perde 8% das frenagens no AiM) | aprovada |
