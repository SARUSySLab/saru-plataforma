...
|---|---|---|
| Linguagem | Python 3.12 + uv | acervo, parsers e analise |
| Catalogo (23 entidades) | Postgres 18 em Docker, porta **5442** | 5432 e 5433 ja ocupadas nesta maquina |
...
| Frontend | Vite + React 19 + TypeScript, zustand, recharts | decisao A: frontend proprio, portando os 13 blocos do `saru-app` |
| Testes | pytest + ruff | |
...
23 entidades e o proximo passo.
